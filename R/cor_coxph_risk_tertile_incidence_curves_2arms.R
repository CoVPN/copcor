...
# load overall.p.tri
tmp=paste0(save.results.to, paste0("coxph_overall_p_tri_", fname.suffix.ls[1], ".Rdata"))
if (file.exists(tmp)) load(tmp)  
overall.p.tri.ls[[1]] = overall.p.tri
# load overall.p.tri
tmp=paste0(save.results.to, paste0("coxph_overall_p_tri_", fname.suffix.ls[2], ".Rdata"))
if (file.exists(tmp)) load(tmp)  
